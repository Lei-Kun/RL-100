# Peg 2048-point online RL without distillation.
# Incremental variant of train_peg_online_rl.sh for the downloaded offline-RL artifact.
# Example:
# bash scripts/Flow/Online/3D/train_peg_2048_online_rl.sh rl100 peg_2048 remote_2048 42
...
# The remote run stores policy, critic/value and dynamics directly under this root.
stage1_run_dir=${ARTIFACT_DIR:-data/peg_flow_chunk16_bc1400_20260920_153843}
run_dir="${stage1_run_dir}"
critic_artifact_dir="${stage1_run_dir}"
